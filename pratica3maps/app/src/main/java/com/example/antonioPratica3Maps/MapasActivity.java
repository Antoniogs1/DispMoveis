...
public class MapasActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private final LatLng Aracaju = new LatLng(-10.968025270722894, -37.04039860611875);
    private final LatLng Vicosa = new LatLng(-20.750976161583967, -42.86991736201387);
    ...
    public void onClickAracaju(View v) {
        goToAracaju();
    }
